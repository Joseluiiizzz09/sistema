...
export default function Dashboard() {
  ...
  function irANuevaVentaDesdeModal() {
    ...
    const obsVal = `${mvTipoDoc}: ${mvDni.trim()}`
    const sel = seleccionado
    if (sel !== null) {
      setClientes(prev => {
    ...
    <div className="dash-root">
      ...
      <div className={`pantalla${tab !== 'rendimiento' ? ' hidden' : ''}`}>
        ...
        <div className="rend-kpis">
          <div className="rend-kpi rend-kpi-azul">   <div className="rend-kpi-icon" /><div className="rend-kpi-valor">{kpiLlamadas}</div>   <div className="rend-kpi-label">Llamadas hoy</div></div>
